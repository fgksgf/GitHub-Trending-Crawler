...
## python
* [Photon](https://github.com/s0md3v/Photon)(**587 stars today**): Incredibly fast crawler which extracts urls, emails, files, website accounts and much more.
...
* [cheat.sh](https://github.com/chubin/cheat.sh)(**157 stars today**): the only cheat sheet you need
* [models](https://github.com/tensorflow/models)(**72 stars today**): Models and examples built with TensorFlow
* [Mask-RCNN](https://github.com/wannabeOG/Mask-RCNN)(**81 stars today**): A PyTorch implementation of the architecture of Mask RCNN, serves as an introduction to working with PyTorch
...
* [public-apis](https://github.com/toddmotto/public-apis)(**65 stars today**): A collective list of public JSON APIs for use in web development.
* [torchbearer](https://github.com/ecs-vlc/torchbearer)(**67 stars today**): torchbearer: A model training library for PyTorch
...
* [dirhunt](https://github.com/Nekmo/dirhunt)(**36 stars today**): Find web directories without bruteforce
...
* [pytorch-maml-rl](https://github.com/tristandeleu/pytorch-maml-rl)(**39 stars today**): Reinforcement Learning with Model-Agnostic Meta-Learning in Pytorch
* [DidierStevensSuite](https://github.com/DidierStevens/DidierStevensSuite)(**34 stars today**): Please no pull requests for this repository. Thanks!
* [Mask_RCNN](https://github.com/matterport/Mask_RCNN)(**32 stars today**): Mask R-CNN for object detection and instance segmentation on Keras and TensorFlow
...
* [featuretools](https://github.com/Featuretools/featuretools)(**35 stars today**): automated feature engineering
...
* [termtosvg](https://github.com/nbedos/termtosvg)(**30 stars today**): Record terminal sessions as SVG animations
